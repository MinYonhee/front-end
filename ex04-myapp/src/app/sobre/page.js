      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          <div className="flex items-center mb-6">
            ...
            <div className="ml-6">
              <h2 className="text-2xl font-semibold">Beatriz Costa</h2>
          ...
          <div className="prose max-w-none">
            <p className="text-lg mb-4">
              Olá! Sou uma desenvolvedora apaixonada por tecnologia e programação. Este aplicativo foi desenvolvido como parte de um projeto para demonstrar minhas habilidades em desenvolvimento web utilizando Next.js e Tailwind CSS.
            </p>
